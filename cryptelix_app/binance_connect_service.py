    ...
    try:
        ...
        try:
            ...
            logger.warning(
                ...
                "Binance WebSocket start failed for user_id=%s: %s",
            ...
            _phase(
                ...
                {"status": "failed", "error": _WS_PHASE_PUBLIC_ERROR},

            )

            result["ws_error"] = _WS_PHASE_PUBLIC_ERROR
        ...
        logger.exception("Binance connect pipeline failed for user_id=%s", user_id)
